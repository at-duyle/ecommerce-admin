class SubCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sub_category.save
        format.html { redirect_to @sub_category, notice: { message: 'Sub category was successfully created.' } }
  ...
  def update
    respond_to do |format|
      if @sub_category.update(sub_category_params)
        format.html { redirect_to @sub_category, notice: { message: 'Sub category was successfully updated.' } }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sub_categories_url, notice: { message: 'Sub category was successfully destroyed.' } }
